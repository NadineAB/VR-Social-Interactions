...
{
    public class WizardOfOzTrailOne : MonoBehaviour
    {
      
        private bool ArkansasshowOptions = false;
        ...
        void Update()
        {
            if (AutoExperimentInstruction.WOZ)
            {
                enableWOZ = true;
            }
            else
        ...
        {
            if (enableWOZ &&
                Time.time > AutoExperimentInstruction.FirstDiscussionTimeStart - 5.0f
                && Time.time < AutoExperimentInstruction.FirstDiscussionTimeEnd + 5.0f)
            {
                GUI.Button(new Rect(550, 10, 300, 100), "Arkansas");
                ArkansasshowOptions = true;
            }
            else
            {
                ArkansasshowOptions = false;
            }
            if (ArkansasshowOptions == true)
            {
                GUIStyle Mainstyle = GUI.skin.GetStyle("Button");
                Mainstyle.fontSize = 20;

                //Left
                if (GUI.Button(new Rect(90, 115, 300, 100), "Picking Diamond"))
                {
                ...
                if (GUI.Button(new Rect(90, 225, 300, 100), "I Love Diamond"))
                {
                ...
                if (GUI.Button(new Rect(90, 335, 300, 100), "Dutch Oven"))
                {
                ...
                if (GUI.Button(new Rect(90, 445, 300, 100), "Keep The Farm Going"))
                {
                ...
                if (GUI.Button(new Rect(90, 555, 300, 100), "Milk Is Boring"))
                {
                ...
                if (GUI.Button(new Rect(90, 765, 300, 100), "Would You Consider Milk"))
                {
                ...
                if (GUI.Button(new Rect(90, 665, 300, 100), "Is That All"))
                {
                ...
                if (GUI.Button(new Rect(400, 225, 300, 100), "Yes I Guess"))
                {
                ...
                if (GUI.Button(new Rect(400, 335, 300, 100), "Hmm"))
                {
                ...
                if (GUI.Button(new Rect(400, 445, 300, 100), "Hmmmm"))
                {
                ...
                if (GUI.Button(new Rect(400, 555, 300, 100), "I Do Not Know"))
                {
                ...
                if (GUI.Button(new Rect(400, 665, 300, 100), "Ha. I never Guessed That"))
                {
                ...
                // middle
                if (GUI.Button(new Rect(710, 115, 300, 100), "I know, Right"))
                {
                ...
                if (GUI.Button(new Rect(710, 225, 300, 100), "Oh. Yeah That One True"))
                {
                ...
                if (GUI.Button(new Rect(710, 335, 300, 100), "No. I Never Been There"))
                {
                ...
                if (GUI.Button(new Rect(710, 445, 300, 100), "Thats All I Know"))
                {
                ...
                if (GUI.Button(new Rect(710, 555, 300, 100), "What Do you Think"))
                {
                ...
                if (GUI.Button(new Rect(710, 665, 300, 100), "I Love That"))
                {
                ...
                // Right
                if (GUI.Button(new Rect(1020, 165, 300, 100), "Interesting"))
                {
                ...
                if (GUI.Button(new Rect(1020, 275, 300, 100), "Oh WOW"))
                {
                ...
                if (GUI.Button(new Rect(1020, 395, 300, 100), "Quite Interesting"))
                {
                ...
                if (GUI.Button(new Rect(1020, 515, 300, 100), "Quite Nice"))
                {
                ...
                if (GUI.Button(new Rect(1020, 625, 300, 100), "That Is Beautiful"))
                {
                ...
                if (GUI.Button(new Rect(1020, 735, 300, 100), "That One Is Awesome"))
                {
                ...
                if (GUI.Button(new Rect(400, 775, 300, 100), "Thats Funny"))
                {
                ...
                if (GUI.Button(new Rect(710, 775, 300, 100), "Silly"))
                {
                ...
                if (GUI.Button(new Rect(1350, 355, 300, 100), "Very Depressing"))
                {
